...
/* Command definitions */
var commandDocValues= [["goTo","Location",["none"],["Sister.location = location."]],["open","CLocation",["CLocation.open = false", "right.free = true"],["CLocation.open = true"]],["close","CLocation",["CLocation.open = true", "right.free = true"],["CLocation.open = false"]],["open","CObject",["CObject.open = false", "right.free=true", "left.holding = Cobject"],["CObject.open = true"]],["close","CObject",["CObject.open = true", "right.free=true", "left.holding = Cobject"],["CObject.open = false"]],["get","Object",["Object.location = Sister.location.", "If Sister.location = CLocation, CLocation.open = true.", "right.free = true."],["Object is in right hand."]],["put","Object, Target location",["Object is in right hand", "BS must be at open location."],["Object is at Target location.", "Right hand is free."]],["hold","Object",["Object is in right hand.", "Left hand must be free."],["Object is in Left hand.", "Right hand is free."]],["scoop","Object",["Object must be spreadable.", "container CObject is in Left hand.", "container CObject is open.", "Knife is in right hand."],["Knife has enough of Object to coat 1 slice."]],["spread","Object, Target Slice",["Knife is in right hand after scooping spreadable object.", "Argument is spreadable object from scoop command", "Left hand is free to steady the slice."],["Target Slice is coated with spreadable object.", "Knife is clean."]],["placeOver","Object",["Coated slice is in right hand.", "Target slice is on plate, coated side face up."],["Coated slice from right hand is aligned face down over coated slice face up on plate.", "Sandwich is now complete."]]];
